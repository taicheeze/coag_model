...
const PetscReal PATCH_LEFT_BOUNDARIES[NUMBER_OF_PATCHES]  = {0.0e-3, 2.0e-3, 3.5e-3}; //previous patch at 2mm to 5mm
const PetscReal PATCH_RIGHT_BOUNDARIES[NUMBER_OF_PATCHES] = {2.0e-3, 3.5e-3, 10.0e-3}; //previous length of channel 20mm
