...
//make vector for freezing	
	Vec myvec;
	ierr = DMCreateGlobalVector(my_data.da_volume_dof_1, &myvec); CHKERRQ(ierr);
	Vec myvec1;
	ierr = DMCreateGlobalVector(my_data.da_volume_dof_1, &myvec1); CHKERRQ(ierr);
	Vec myvec4;
