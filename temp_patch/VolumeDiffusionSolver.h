...
//          if(i==29 && k == 3){
              PetscPrintf(PETSC_COMM_SELF,"ah ha, t=%G, i=%d, k=%d, temp_c=%G, prev_c0=%G, prev_c1=%G, prev_c0_left=%G, prev_c0_right=%G, c0=%G, c1=%G, c0_left=%G, c0_right=%G, ratio0=%G, ratio1=%G\n",t,i,k,temp_c,array_prev_c_volume[0][i], array_prev_c_volume[1][i],array_prev_c_volume[0][i-1], array_prev_c_volume[0][i+1], array_c_volume[0][i], array_c_volume[1][i],array_c_volume[0][i-1],array_c_volume[0][i+1], solver_ptr->bffs.ratio_layer0, solver_ptr->bffs.ratio_layer1);
              PetscPrintf(PETSC_COMM_SELF,"ah ha, t=%G, i=%d, k=%d, alpha=%G, beta=%G\n",t,i,k,array_alpha_global[i].c[k],array_beta_global[i].c[k]);
          }
        }
