...
#define NUMBER_OF_X_GRIDS         100 //reduced from 100 
...
#define X_LENGTH          20000.0e-6 //reduced from 20000e-6
#define Y_LENGTH            25.0e-6 //reduced from 250e-6
#define Y_BOTTOM_LENGTH      2.0e-6 //reduced from 20e-6
...
const PetscReal PATCH_LEFT_BOUNDARIES[NUMBER_OF_PATCHES]  = {0.0e-3, 5.0e-3, 6.0e-3}; //previous patch at 2mm to 5mm
const PetscReal PATCH_RIGHT_BOUNDARIES[NUMBER_OF_PATCHES] = {5.0e-3, 6.0e-3, 20.0e-3}; //previous length of channel 20mm
